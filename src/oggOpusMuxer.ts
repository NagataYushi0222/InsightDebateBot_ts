...
export class OggOpusMuxer {
    ...
    packet(packet: Buffer): Buffer { this.granule += samples(packet); return this.page(packet, 0, this.granule); }
    end(): Buffer { return this.page(Buffer.alloc(0), 4, this.granule); }
